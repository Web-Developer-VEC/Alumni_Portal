  ...
  <div class="email-wrapper">
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          Welcome to the Velammal Engineering College Alumni Portal.
        </p>


        <p>
          You are receiving this email because a registration request was initiated for this email address. 
        ...
        <div class="info-box">
          ...
          <p>
            <strong>Note:</strong> This OTP is valid for 5 minutes. If you did not request this verification, 
